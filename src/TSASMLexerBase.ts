...
import { TSASMLexer } from './lexer/grammar/TSASMLexer'

// add this to generated ./lexer/grammar/TSASMLexer.ts
 ...
 */
export abstract class TSASMLexerBase extends Lexer {
    /**
    ...
    protected ProcessStringLiteral() {
        if (this.lastToken == null || this.lastToken.type == TSASMLexer.OpenBrace) {
    ...
    protected IsRegexPossible() {
        ...
        switch (this.lastToken.type) {
            case TSASMLexer.Identifier:
            case TSASMLexer.NullLiteral:
            case TSASMLexer.BooleanLiteral:
            case TSASMLexer.CloseBracket:
            case TSASMLexer.CloseParen:
            case TSASMLexer.OctalIntegerLiteral:
            case TSASMLexer.DecimalLiteral:
            case TSASMLexer.HexIntegerLiteral:
            case TSASMLexer.StringLiteral:
            case TSASMLexer.PlusPlus:
            case TSASMLexer.MinusMinus:
